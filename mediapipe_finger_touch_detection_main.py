                    ...
                    if hand_results and hand_results.multi_hand_world_landmarks:
                        ...
                        for j in range(len(hand_results.multi_handedness)):
                            ...
                            self.data += "{}|{}|{}|{}|{}\n".format(
                                ...
                                .label,
                                4,
                                hand_world_landmarks.landmark[4].x,
                                hand_world_landmarks.landmark[4].y,
                                hand_world_landmarks.landmark[4].z,
                            )
                            thumb_coordinates = (hand_world_landmarks.landmark[4].x, hand_world_landmarks.landmark[4].y, hand_world_landmarks.landmark[4].z)
                            ...
                            for i in [8, 12, 16, 20]:
                                ...
                                finger_coordinates = (hand_world_landmarks.landmark[i].x, hand_world_landmarks.landmark[i].y, hand_world_landmarks.landmark[i].z)
                                # print("{}: {}".format(i, ((thumb_coordinates[0] - finger_coordinates[0])**2 + (thumb_coordinates[1] - finger_coordinates[1])**2 + (thumb_coordinates[2] - finger_coordinates[2])**2)**0.5))
                                distances[int(i/4-2)] = (i, ((thumb_coordinates[0] - finger_coordinates[0])**2 + (thumb_coordinates[1] - finger_coordinates[1])**2 + (thumb_coordinates[2] - finger_coordinates[2])**2)**0.5)
                                # if (((thumb_coordinates[0] - finger_coordinates[0])**2 + (thumb_coordinates[1] - finger_coordinates[1])**2 + (thumb_coordinates[2] - finger_coordinates[2])**2)**0.5 <= 0.035):
                                #     print("Finger {} touching thumb\n".format(i))
                            # print(self.data)
