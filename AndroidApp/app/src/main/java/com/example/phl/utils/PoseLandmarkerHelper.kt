...
class PoseLandmarkerHelper(
    ...
    fun setupPoseLandmarker() {
        ...
        try {
            ...
            poseLandmarkerHelperListener?.onPoseLandmarkerError(
...
//        imageProxy.close()
    ...
    private fun returnLivestreamResult(
        ...
        poseLandmarkerHelperListener?.onPoseLandmarkerResults(
            ResultBundle(
                listOf(result),
                inferenceTime,
                input.height,
    ...
    interface LandmarkerListener {
        fun onPoseLandmarkerError(error: String, errorCode: Int = OTHER_ERROR)
        fun onPoseLandmarkerResults(resultBundle: ResultBundle)
    }
}