...
class HandLandmarkerHelper(
    ...
    fun setupHandLandmarker() {
        ...
        try {
            ...
            handLandmarkerHelperListener?.onHandLandmarkerError(
    ...
    private fun returnLivestreamResult(
        ...
        handLandmarkerHelperListener?.onHandLandmarkerResults(
            ResultBundle(
                listOf(result),
                inferenceTime,
                input.height,
    ...
    interface LandmarkerListener {
        fun onHandLandmarkerError(error: String, errorCode: Int = OTHER_ERROR)
        fun onHandLandmarkerResults(resultBundle: ResultBundle)
    }
}
